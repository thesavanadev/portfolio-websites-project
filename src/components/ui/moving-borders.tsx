...
export function Button({
	...
	return (
		<Component
			...
			{...otherProps}
		>
			<div className="rounde-[1.75rem] absolute inset-0" style={{ borderRadius: `calc(${borderRadius} * 0.96)` }}>
				<MovingBorder duration={duration} rx="30%" ry="30%">
					<div
						className={cn("h-20 w-20 bg-[radial-gradient(#CBACF9_40%,transparent_60%)] opacity-[0.8]", borderClassName)}
					/>
				</MovingBorder>
			</div>
